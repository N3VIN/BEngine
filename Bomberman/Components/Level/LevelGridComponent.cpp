...
float bomberman::LevelGridComponent::GetCellSize() const {
    return m_cellSize;
}

int bomberman::LevelGridComponent::GetColumns() const {
    return m_columns;
}

int bomberman::LevelGridComponent::GetRows() const {
    return m_rows;
}

glm::ivec2 bomberman::LevelGridComponent::GetDimensions() const {
    return {m_columns, m_rows};
}

glm::vec2 bomberman::LevelGridComponent::GetOrigin() const {
    return m_origin;
}
...
glm::ivec2 bomberman::LevelGridComponent::GetExitCell() const {
    return m_exitCell;
}

const std::vector<bomberman::PickupSpawn> &bomberman::LevelGridComponent::GetPickups() const {
    return m_pickups;
}
