...
namespace dae {
    BombManagerComponent::BombManagerComponent(GameObject *parent, Scene *scene, LevelGridComponent *gridComponent)
      ...
      , m_gridComponent(gridComponent) {
        ...
        m_detonationSub = ServiceLocator::GetEventBus().Subscribe<events::BombDetonated>(
        ...
        m_explosionExpiredSub = ServiceLocator::GetEventBus().Subscribe<events::ExplosionExpired>(
    ...
    void BombManagerComponent::SpreadInDirection(glm::ivec2 origin, glm::ivec2 direction, int range) {
        auto &bus = ServiceLocator::GetEventBus();
    ...
    void BombManagerComponent::SpawnExplosionAt(glm::ivec2 cell) {
        ...
        auto explosionGO = std::make_unique<GameObject>();
    ...
    GameObject *BombManagerComponent::BombAt(glm::ivec2 cell) const {
        if (!m_gridComponent->InBounds(cell)) {
            return nullptr;
        }
    ...
    void BombManagerComponent::OnExplosionCellExpired(glm::ivec2 cell) {
        const auto idx = BombIndex(cell);
